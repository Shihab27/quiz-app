...
function initApp() {
    ...
    quiz = new Quiz(
        ...
        `Our javascript quiz covers javascript fundamentals, advance concepts, and other topics. The total time allowed for the online JavaScript quiz questions to be answered is 70 seconds. Once the time is up, it will automatically be submitted.`,
        70,
        questions);
